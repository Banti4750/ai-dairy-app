...
//         return `Date: ${date}, Mood: ${mood}, Title: ${title}, Content: ${content}`;
//       }).join('\n')
...
// DIARY ENTRIES (${entryCount} entries):
// ${entriesText}

// IMPORTANT: Respond with ONLY valid JSON. Do not include any text before or after the JSON object. Do not use markdown formatting or code blocks.
...
// Be specific, compassionate, and evidence-based. Focus on actionable insights and maintain professional mental health assessment standards. If there are no entries to analyze, provide general mental health guidance based on the user profile.

// REMEMBER: Return ONLY the JSON object with no additional text, explanations, or formatting.
// `;
//   } catch (error) {
...
//   try {
//     const historicalData = historicalAnalyses && Array.isArray(historicalAnalyses)
//       ? JSON.stringify(historicalAnalyses)
//       : 'No historical data available';

//     const trendsData = currentTrends && typeof currentTrends === 'object'
//       ? JSON.stringify(currentTrends)
//       : 'No current trends data available';

//     const profileData = userProfile && typeof userProfile === 'object'
...
// HISTORICAL ANALYSES: ${historicalData}
// CURRENT TRENDS: ${trendsData}
...
// If limited data is available, provide general predictive guidance based on common mental health patterns.
// `;
//   } catch (error) {
//     console.error('Error creating predictive prompt:', error);
//     return `Please provide general mental health predictions and recommendations.`;
//   }
// };
